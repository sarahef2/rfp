...
regForestFit <- function(datasetX_R, datasetY_R, ncat_R, subjectweight_R, variableweight_R, parameters_R, usecores_R) {
    .Call(`_RLT_regForestFit`, datasetX_R, datasetY_R, ncat_R, subjectweight_R, variableweight_R, parameters_R, usecores_R)
}
